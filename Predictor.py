...
with col2:
    Vc = st.number_input("**Vc** - shear contribution of concrete / kN", min_value=32.0, max_value=2830.0, value=200.0)
    Vs = st.number_input("**Vs** - shear contribution of transverse reinforcement / kN", min_value=0.0, max_value=3580.0, value=150.0)
    Vl = st.number_input("**Vl** - shear contribution of longitudinal reinforcement / kN", min_value=25.0, max_value=11400.0, value=300.0)
    Vp = st.number_input("**Vp** - shear contribution of axial force / kN", min_value=0.0, max_value=2520.0, value=0.0)
